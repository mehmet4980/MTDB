...
@section('bodytag')
	<body id="titles-index" class="people">
@stop
	...
	<div class="container" id="content">
		...
		<section data-bind="foreach: sourceItems" class="row">
			...
			<figure class="col-sm-4 col-md-3 col-lg-2 pretty-figure">
				...
				<figcaption class="no-rating"><a data-bind="attr: { href: vars.urls.baseUrl+'/'+vars.trans.people+'/'+id+'-'+name.replace(/\s+/g, '-').toLowerCase() }, text: name.trunc(30)"></a></figure>
			</figure>
