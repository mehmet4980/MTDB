...
@show
    ...
    <head>
        ...
        @section('assets')
            ...
            {{ HTML::style('themes/mercury/assets/css/styles.min.css?v12') }}
            {{ Hooks::renderCss() }}
        @show
    </head>
    ...
    <script>
        var vars = {
            ...
            urls: {
                ...
                movies: '<?php echo route('movies.index'); ?>',
                series: '<?php echo route('series.index'); ?>',
            },
            settings: {
    ...
    {{ HTML::script('assets/js/scripts.min.js?v12') }}
    {{ HTML::script('themes/mercury/assets/js/parallax.min.js?v12') }}
    {{ Hooks::renderScripts() }}
