        ...
        <section class="container" id="content">
            ...
            <div class="col-sm-9">
                ...
                @if (isset($episodes->previous) && isset($episodes->next))
                    <div id="episodes-guide" data-bind="moreLess: 150" class="row">
                ...
                @if ($ad = $options->getTitleJumboAd())
                    <div id="ad" class="jumbo-ad">{{ $ad }}</div>
                @endif

                <div id="lists">
                	@if (Hooks::hasReplace('Titles.Show.LinksPanel') && ! Helpers::hasLinks($title))
                ...
                <ul class="nav nav-tabs">
                    ...
                    @if(Helpers::hasAccess('titles.edit'))
                        <li class="hidden-xs hidden-sm"><a href="{{ Request::url().'/edit' }}">{{ trans('dash.edit') }}</a></li>
                    @endif
                </ul>
                        ...
                        @foreach($title->actor as $actor)
                            @if(!str_contains($actor->image, 'imdbnoimage'))
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="media-heading"><a href="{{ Helpers::url($actor->name, $actor->id, 'people') }}">{{ str_limit($actor->name, 33) }}</a></h4>
                        ...
                        <ul class="boxed-items" data-bind="foreach: filteredReviews">
                            ...
                            <!--googleoff: all-->
                                ...
                                <li class="clearfix">
                                    ...
                                    <div class="rating" data-bind="raty: score, stars: 10, readOnly: true, convert: type ==='crtic'"></div>
            ...
            <div class="col-sm-3 images" id="images-col">
                @foreach($title->image->slice(0,6) as $img)
...
@section('scripts')
    ...
    <script>
        ...
        ko.applyBindings(app.viewModels.reviews, $('.bind-reviews')[0]);
